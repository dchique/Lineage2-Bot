...
#            print("#####DEVICE ID:"+str(device))
    ...
    def moveMouseToPosition(self, x, y):
        width_constant = 65535.0/float(self.user32.GetSystemMetrics(78))
        height_constant = 65535.0/float(self.user32.GetSystemMetrics(79)) 
        x_left = self.user32.GetSystemMetrics(76)
        y_top = self.user32.GetSystemMetrics(77)
        ...
        stroke.x = int((float(x)-float(x_left))*width_constant)
        stroke.y = int((float(y)-float(y_top))*height_constant)
